// GLOBAL THEME TOGGLE WITH LOCAL STORAGE
...
function sendChatMessage() {
  ...
  setTimeout(() => {
    ...
    if (textLower.includes('hi') || textLower.includes('hello') || textLower.includes('hey')) {
      responseHTML = "Hello there! Welcome to AutoIndia Motors[cite: 2]. How can I assist you with finding your dream car today?";
    } 
