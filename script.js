// GLOBAL THEME TOGGLE WITH LOCAL STORAGE & RENDER AUTOMATIC URL SWITCHING
const isProduction = window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1';
const API_URL = isProduction ? 'https://auto-india-motors.onrender.com/api' : 'http://localhost:5000/api';
const BACKEND_URL = isProduction ? 'https://auto-india-motors.onrender.com' : 'http://localhost:5000';
